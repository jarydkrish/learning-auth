...
class Api::SessionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "login with valid credentials" do
    post api_login_url, params: { email_address: @user.email_address, password: "password123" }
    assert_response :success
    assert_not_nil response.parsed_body["token"]
  end

  test "login with invalid credentials" do
    post api_login_url, params: { email_address: @user.email_address, password: "wrong_password" }
